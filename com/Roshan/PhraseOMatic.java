...
public class PhraseOMatic {
    public static void main(String[] args){
        ...
        "smart","six-sigme","critical-path","dynamic"};
        ...
        String[] wordListThree = {"process","tippin-point","solution","architecture","core competency","strategy","mindshare","portal","space","vision",
        "paradigm","mission"};
